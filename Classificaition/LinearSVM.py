...
def train_linear_svm(data_matrix, n_samples, k, labels, test_size=0.2, random_state=42):
    """
    주어진 데이터 행렬을 사용하여 LinearSVC 모델을 학습하고 평가하는 함수
...
accuracy = train_linear_svm(data_matrix, n_samples, k, labels, test_size=0.2)
